        ...
        try {
            ...
            if (token) {
                const base = (function() {
                    ...
                    var b = (window.__kynAPI && window.__kynAPI.baseUrl) || window.__API_BASE_URL || window.API_BASE_URL || window.__API_BASE || (window.__getApiBase && window.__getApiBase()) || 'https://nexora-3bla.onrender.com/api';
