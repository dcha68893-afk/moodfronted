...
const _normalizeProduct = (raw) => ({
    ...
    materials:       raw.materials || raw.metadata?.materials || [],
    variants:        Array.isArray(raw.variants) ? raw.variants : (raw.metadata?.variants || []),
    is_featured:     !!(raw.is_featured || raw.isFeatured || raw.featured),
    is_flash_sale:   !!(raw.is_flash_sale || raw.isFlashSale),
    flash_end:       raw.flash_end || raw.flashEnd || raw.flashSaleEnd || null,
