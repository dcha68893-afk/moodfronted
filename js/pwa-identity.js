/* Runtime PWA identity normalizer. Keeps legacy HTML metadata aligned with canonical Necpra assets. */
(function(){
'use strict';
function fix(){
 const canonical='/icons/necpra-512.svg';
 document.title='Necpra - Global Chat Platform | Messaging & Marketplace';
 ...
 const desc=document.querySelector('meta[name="description"]');if(desc)desc.content='Necpra — secure messaging, social communication and marketplace.';
}
