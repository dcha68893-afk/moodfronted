...
function showViewer(){
 ...
 api('/view',{method:'POST',body:JSON.stringify({statusId:s.id})}).then(r=>{s.viewCount=Number(s.viewCount||0)+(r.created?1:0);s.viewedByMe=true;renderFeed();renderPeople();}).catch(()=>{});
...
#necpa-status-root{padding:0!important}
