...
function viewerVisual(s){
 ...
 if(s.type==='video'&&s.mediaUrl)return '<video class="ns-viewer-media" data-status-video src="'+esc(s.mediaUrl)+'"'+(cldVideoPoster(s.mediaUrl)?' poster="'+esc(cldVideoPoster(s.mediaUrl,720))+'"':'')+' controls autoplay muted playsinline preload="auto" onerror="window.__necpaStatusMediaError(this)"></video>';
