...
function mount(){
 ...
 root.querySelectorAll('[data-browse]').forEach(b=>b.onclick=()=>setPanel('feed'));
...
function showViewer(){
 ...
 clearInterval(state.timer);if(!isReplay)state.timer=setTimeout(()=>move(1),Math.max(3000,(Number(s.durationSeconds)||7)*1000));
}
...
#necpa-status-root .ns-viewer{inset:0!important;width:100%!important;height:100%!important}
#necpa-status-root .ns-viewer-stage{width:100%!important;max-width:none!important;height:100%!important;min-height:100%!important}
...
.ns-arrow,.ns-back,.ns-browse{display:none}
...
#necpa-status-root.ns-mobile .ns-arrow{display:inline}
