...
window.addEventListener('kyn:status:new',()=>loadFeed());window.addEventListener('message',e=>{if(e.data?.type==='status:new'||e.data?.type==='STATUS_NEW'||e.data?.type==='FRIEND_STATUS_NEW')loadFeed()});
