...
(function(){
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.showStatus = function(message, type = 'info', duration = 3000) {
            // Remove existing status messages to prevent accumulation
        ...
        document.addEventListener('submit', function(e) {
            ...
            if (form.method === 'post' && !form.hasAttribute('data-ajax-disabled')) {
                ...
                setTimeout(() => {
                    window.showStatus('Form submitted successfully!', 'success');
                    if (submitBtn) {
        ...
        document.querySelectorAll('[data-tooltip]').forEach(element => {
            element.addEventListener('mouseenter', function(e) {
                ...
                this.addEventListener('mouseleave', cleanup, { once: true });
            });
        });
