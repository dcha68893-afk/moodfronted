...
(function _pwaManager() {
    ...
    function _renderInstallBanner() {
        ...
        _inject('pwaInstallBanner',
            ...
            '<img src="/necpa-192.png" style="width:46px;height:46px;border-radius:12px;flex-shrink:0;object-fit:cover" onerror="this.style.display=\'none\'">' +
            '<div style="flex:1;min-width:0">' +
            '  <div style="font-weight:800;font-size:14px;color:#111;line-height:1.2">Install Necpa</div>' +
