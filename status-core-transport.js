...
// Connection / transport layer: iframe environment detection, safe
// storage layer, compatibility & origin adapters, startup governor,
// iframe transport, heartbeat + session clients, reliability engine,
// message dispatcher, security validator, parent connection manager,
// handshake manager, recovery manager, navigation guard, UI failsafe,
// multi-module coordinator.
// Must load AFTER status-core-state.js (uses its top-level state) and
// BEFORE status-core-runtime.js. Loaded as a plain classic <script>.
// =============================================
